...
class Panel extends Nette\Object implements Tracy\IBarPanel
{
    ...
    public function getTab()
    {
        ...
        return '<span title="Kdyby/Events">' . '<img width="16" height="16" src="data:image/png;base64,' . base64_encode(file_get_contents(__DIR__ . '/icon.png')) . '" />' . '<span class="tracy-label">' . count(Arrays::flatten($this->dispatchLog)) . ' calls</span>' . '</span>';
    }
    /**
    ...
    {
        return '			#nette-debug .nette-panel .nette-KdybyEventsPanel,
